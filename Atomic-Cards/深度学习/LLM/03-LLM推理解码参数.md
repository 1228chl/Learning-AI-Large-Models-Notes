...
- 需要理解 GPT 与自回归生成的相关知识，参见 [GPT与自回归生成](../../NLP/预训练/02-GPT与自回归生成.md)
- 需要理解提示词工程核心原则的相关知识，参见 [提示词工程核心原则](../../AI-Agent/基础/03-提示词工程核心原则.md)
...
- 需要理解 ChatGPT/GPT 系列模型的工程实践，参见 [GPT与自回归生成](../../NLP/预训练/02-GPT与自回归生成.md)