...
- 需要理解 GPT 与自回归生成的相关知识，参见 [GPT与自回归生成](../../NLP/预训练/11-GPT与自回归生成.md)
- 需要理解提示词工程核心原则的相关知识，参见 [提示词工程核心原则](../../AI-Agent/基础/06-提示词工程核心原则.md)
- 需要理解 Agent 定义与核心公式的相关知识，参见 [Agent定义与核心公式](../../AI-Agent/基础/01-Agent定义与核心公式.md)
- 需要理解 Transformer 中 Softmax 归一化的数学根基，参见 [逻辑回归与Softmax](../../机器学习/监督学习/02-逻辑回归.md)
- 需要理解 ChatGPT/GPT 系列模型的工程实践，参见 [GPT与自回归生成](../../NLP/预训练/11-GPT与自回归生成.md)