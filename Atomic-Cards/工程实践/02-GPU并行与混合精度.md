...
> 掌握进程与线程的编程实现可参见 [进程与线程](../Python/06-进程与线程.md)；理解PyTorch张量与运算的深度学习原理可参见 [PyTorch张量与运算](../深度学习/07-PyTorch张量与运算.md)；理解卷积运算的深度学习原理可参见 [卷积运算](../深度学习/09-卷积运算.md)；理解反向传播算法的深度学习原理可参见 [反向传播算法](../深度学习/04-反向传播算法.md)；理解前置知识可参见 [模型保存格式](./05-模型保存格式.md)