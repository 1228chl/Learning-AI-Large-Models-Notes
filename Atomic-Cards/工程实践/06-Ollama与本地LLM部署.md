...
> 理解前置知识可参见 [LLM API调用与ChatBot](./07-LLM API调用与ChatBot.md)；理解提示词工程核心原则的AI应用开发可参见 [提示词工程核心原则](../AI-Agent/06-提示词工程核心原则.md)；理解前置知识可参见 [模型保存格式](./05-模型保存格式.md)；理解前置知识可参见 [Docker基础与容器化](./01-Docker基础与容器化.md)