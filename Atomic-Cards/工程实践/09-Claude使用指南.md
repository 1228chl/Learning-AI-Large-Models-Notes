...
## 参考引用
- 需要理解 LLM API 调用与聊天机器人开发的相关知识，参见 [LLM API调用与ChatBot](./07-LLM%20API调用与ChatBot.md)
- 需要理解 Ollama 与本地 LLM 部署的相关知识，参见 [Ollama与本地LLM部署](./06-Ollama与本地LLM部署.md)
- 需要理解 Prompt Engineering 核心原则的相关知识，参见 [提示词工程核心原则](../AI-Agent/06-提示词工程核心原则.md)
- 需要理解 Agent 定义与核心公式的相关知识，参见 [Agent定义与核心公式](../AI-Agent/01-Agent定义与核心公式.md)
