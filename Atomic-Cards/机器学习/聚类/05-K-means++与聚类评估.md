...
- 需要理解 K-means 聚类的基本原理参见 [K-means聚类](./01-K-means聚类.md)
- 需要理解 DBSCAN 密度聚类与 K-means 的对比参见 [DBSCAN密度聚类](./03-DBSCAN密度聚类.md)
- 需要理解聚类评估中的轮廓系数和 CH 指数参见 [层次聚类](./04-层次聚类.md)
- 需要理解距离度量对聚类的影响参见 [距离度量](../../数学基础/线性代数/向量/05-距离度量.md)