...
- 需要理解分类与回归评估指标的相关知识，参见 [评估指标](./04-评估指标.md)
- 需要理解语言模型发展脉络与核心概念，参见 [语言模型发展史](../深度学习/22-语言模型发展史.md)
- 需要掌握交叉熵与概率分布的数学基础，参见 [损失函数：交叉熵](../深度学习/03-损失函数.md) 与 [随机变量与概率分布](../概率统计/03-随机变量与概率分布.md)