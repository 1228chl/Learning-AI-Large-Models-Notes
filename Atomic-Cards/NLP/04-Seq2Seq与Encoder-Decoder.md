...
> 理解RNN与序列建模的深度学习原理可参见 [RNN与序列建模](../深度学习/11-RNN与序列建模.md)；理解前置知识可参见 [注意力机制](./05-注意力机制.md)；理解前置知识可参见 [自注意力与Transformer](./06-自注意力与Transformer.md)；理解矩阵乘法的数学原理可参见 [矩阵乘法](../线性代数/04-矩阵乘法.md)