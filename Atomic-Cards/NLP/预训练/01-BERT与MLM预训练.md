...
## 参考引用
- 需要理解残差连接与LayerNorm的相关知识，参见 [残差连接与LayerNorm](../组件/01-残差连接与LayerNorm.md)
- 需要理解HuggingFace Transformers库的相关知识，参见 [HuggingFace Transformers库](03-HuggingFace Transformers库.md)
- 需要理解GPT与自回归生成的相关知识，参见 [GPT与自回归生成](02-GPT与自回归生成.md)
- 需要理解自注意力与Transformer的相关知识，参见 [自注意力与Transformer](../架构/03-自注意力与Transformer.md)
- 需要理解多头注意力的相关知识，参见 [多头注意力](../架构/04-多头注意力.md)
