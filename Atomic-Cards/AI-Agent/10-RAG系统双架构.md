...
> 理解前置知识可参见 [RAG三阶段流程](./02-RAG三阶段流程.md)；理解前置知识可参见 [文档切分策略](./03-文档切分策略.md)；理解PyMySQL模块的数据存储与检索可参见 [PyMySQL模块](../数据库/04-PyMySQL模块.md)；理解前置知识可参见 [FAQ与RAG混合检索架构](./26-FAQ与RAG混合检索架构.md)