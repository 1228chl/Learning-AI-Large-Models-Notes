...
- 需要了解 Hooks 如何实现权限检查的插拔参见 [Hooks 系统](../01-Tools-Execution/04-Hooks系统.md)
- 需要理解工具分发与权限的关系参见 [工具分发系统](../01-Tools-Execution/02-工具分发系统.md)
- 需要掌握 Agent 循环整体流程参见 [Agent 循环](../01-Tools-Execution/01-Agent循环.md)
