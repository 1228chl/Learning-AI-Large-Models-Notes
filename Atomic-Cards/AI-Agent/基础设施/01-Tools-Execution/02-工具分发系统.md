...
- 需要理解 Agent 循环整体架构参见 [Agent 循环](../01-Tools-Execution/01-Agent循环.md)
- 需要了解权限系统对工具执行的拦截参见 [权限系统](../01-Tools-Execution/03-权限系统.md)
- 需要理解 Hooks 对工具执行的前后扩展参见 [Hooks 系统](../01-Tools-Execution/04-Hooks系统.md)
- 需要了解 MCP 动态工具池参见 [MCP 插件集成](../05-Multi-Agent-Platform/03-MCP插件集成.md)
