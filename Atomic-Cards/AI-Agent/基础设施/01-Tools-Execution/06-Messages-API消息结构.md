...
- 需要了解 Agent 循环如何驱动消息轮次参见 [Agent 循环](../01-Tools-Execution/01-Agent循环.md)
- 需要掌握工具分发中 tool_use 的处理参见 [工具分发系统](../01-Tools-Execution/02-工具分发系统.md)
- 需要了解错误恢复中 tool_result 的处理参见 [错误恢复与重试](../02-Planning-Control/02-错误恢复与重试.md)
- 需要理解 LLM API 调用方式参见 [LLM API 调用与 ChatBot](../../Tools/部署/07-LLM%20API调用与ChatBot.md)