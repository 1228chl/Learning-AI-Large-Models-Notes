...
- 需要理解 Agent 循环中压缩的触发时机参见 [Agent 循环](../01-Tools-Execution/01-Agent循环.md)
- 需要了解记忆系统与压缩管线的配合参见 [记忆系统](../03-Memory-Management/02-记忆系统.md)
- 需要掌握错误恢复中的 reactive_compact 参见 [错误恢复与重试](../02-Planning-Control/02-错误恢复与重试.md)
- 需要理解 Harness 整体设计参见 [Agent Harness（基础设施层）](../05-Multi-Agent-Platform/01-Agent-Harness基础设施层.md)
- 需要了解系统提示词组装中的上下文管理参见 [系统提示词组装](../02-Planning-Control/03-系统提示词组装.md)
