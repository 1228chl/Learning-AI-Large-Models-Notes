...
- 需要了解记忆系统注入到 System Prompt 的方式参见 [记忆系统](../03-Memory-Management/02-记忆系统.md)
- 需要理解技能加载中的两级注入参见 [上下文压缩管线](../03-Memory-Management/01-上下文压缩管线.md)
- 需要掌握 Agent 循环中 System Prompt 的使用参见 [Agent 循环](../01-Tools-Execution/01-Agent循环.md)
