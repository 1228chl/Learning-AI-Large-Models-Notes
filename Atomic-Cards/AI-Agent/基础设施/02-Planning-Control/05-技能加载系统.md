...
- 需要了解系统提示词组装中的技能注入参见 [系统提示词组装](../02-Planning-Control/03-系统提示词组装.md)
- 需要理解上下文压缩与技能加载的配合参见 [上下文压缩管线](../03-Memory-Management/01-上下文压缩管线.md)
- 需要掌握工具分发系统参见 [工具分发系统](../01-Tools-Execution/02-工具分发系统.md)
