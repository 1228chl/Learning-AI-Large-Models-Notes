...
- 需要了解任务系统与 worktree 的绑定参见 [任务系统](../05-Multi-Agent-Platform/04-任务系统.md)
- 需要掌握自主 Agent 在 worktree 中的工作方式参见 [自主 Agent](../05-Multi-Agent-Platform/06-自主Agent.md)
- 需要理解子 Agent 的隔离执行参见 [子 Agent](../02-Planning-Control/01-子Agent.md)
