...
> 理解前置知识可参见 [RAG三阶段流程](./02-RAG三阶段流程.md)；理解前置知识可参见 [RAG系统双架构](./10-RAG系统双架构.md)；理解前置知识可参见 [RAG系统完整实现](./23-RAG系统完整实现.md)；理解评估指标的机器学习原理可参见 [评估指标](../机器学习/04-评估指标.md)；理解词嵌入与分布式表示的NLP原理可参见 [词嵌入与分布式表示](../NLP/02-词嵌入与分布式表示.md)