...
> 理解前置知识可参见 [Agent定义与核心公式](./01-Agent定义与核心公式.md)；理解前置知识可参见 [LangChain六大组件](./04-LangChain六大组件.md)；理解Milvus核心概念的数据存储与检索可参见 [Milvus核心概念](../数据库/08-Milvus核心概念.md)；理解前置知识可参见 [RAG查询改写与意图识别](./27-RAG查询改写与意图识别.md)