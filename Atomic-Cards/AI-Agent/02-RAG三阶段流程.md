...
| 应用场景 | 检索策略 | 说明 |
|:--------:|:--------|:----|
| **RAG 知识库问答** | 直接检索 | 通用查询场景，查询向量与文档向量最近邻搜索 |
| **短查询模糊检索** | HyDE（假设文档检索） | 先让 LLM 生成假设答案再检索，补充短查询的语义信息 |
| **多维度复杂查询** | 子查询 | 将多意图问题拆分为多个子问题分别检索后合并去重 |
| **迭代信息补充** | 回溯问题（RQ-RAG） | 根据已检索内容迭代生成新查询，直到信息充足 |
