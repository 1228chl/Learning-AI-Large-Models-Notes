...
- 需要了解 HyDE 假设文档检索的相关知识，参见 [HyDE假设文档检索实现](./07-HyDE假设文档检索实现.md)
- 需要了解智能分块策略的相关知识，参见 [文档切分策略](./02-文档切分策略.md)
- 需要了解 BGE-M3 嵌入模型的相关知识，参见 [BGE-M3嵌入模型与混合检索](./06-BGE-M3嵌入模型与混合检索.md)
- 需要了解 Milvus 集合 Schema 设计的相关知识，参见 [Milvus集合Schema设计与索引选择](./11-Milvus集合Schema设计与索引选择.md)