...
- 需要掌握 RAG 流程中的检索与生成衔接，参见 [RAG 三阶段流程](../RAG流程/02-RAG三阶段流程.md)
- 需要了解 LangChain 如何实现工作流编排，参见 [LangChain 六大组件](../LangChain/04-LangChain六大组件.md)
- 需要理解并行处理与性能优化，参见 [GPU 并行与混合精度](../../深度学习/训练优化/02-GPU并行与混合精度.md)
- 需要了解分布式任务调度与容错，参见 [Docker 基础与容器化](../../Project/Docker/01-Docker基础与容器化.md)
