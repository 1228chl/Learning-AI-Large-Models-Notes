...
- 需要理解嵌入与向量化的相关知识，参见 [嵌入与向量化](../数据库/10-嵌入与向量化.md)
- 需要理解Milvus Python操作的相关知识，参见 [Milvus Python操作指南](../数据库/09-Milvus Python操作指南.md)
- 需要理解Python类与对象以理解加载器字典模式，参见 [类与对象](../Python/01-类与对象.md)