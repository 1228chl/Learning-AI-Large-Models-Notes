...
- 需要理解单个 Agent 的基础定义与架构的相关知识，参见 [Agent 定义与核心公式](../基础/01-Agent定义与核心公式.md)
- 需要掌握工作流编排如何串联多个 Agent 的相关知识，参见 [工作流编排](../平台/09-工作流编排(Workflow).md)
- 需要了解多智能体强化学习（MARL）的数学基础的相关知识，参见 [概率空间与事件运算](../../数学基础/概率统计/01-概率空间与事件运算.md)
- 需要理解通信协议中的消息序列化的相关知识，参见 [Socket 网络编程](../../Python/工具/09-Socket网络编程.md)
- 需要了解多 Agent 部署的容器化方案的相关知识，参见 [Docker 基础与容器化](../../Project/Docker/01-Docker基础与容器化.md)
