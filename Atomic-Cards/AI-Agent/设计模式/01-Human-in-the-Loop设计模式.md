...
- 需要理解提示词工程中如何设计人工审核指令，参见 [提示词工程核心原则](../基础/03-提示词工程核心原则.md)
- 需要了解 Agent 生命周期管理中中断点的处理，参见 [Agent 定义与核心公式](../基础/01-Agent定义与核心公式.md)
- 需要了解状态机设计模式中中断点的处理，参见 [状态机对话设计模式](02-状态机对话设计模式.md)