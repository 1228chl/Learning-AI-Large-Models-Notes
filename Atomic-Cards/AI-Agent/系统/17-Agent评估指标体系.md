...
- 需要理解 RAGAS 框架中 Faithfullness、Context Relevancy 等自动化评估指标：[RAG 系统评估 RAGAS](../系统/03-RAG系统评估(RAGAS).md)
- 需要理解 LLM-as-Judge 的语义评判设计和人工交叉验证：[LLM-as-Judge 评估模式](../基础/06-LLM-as-Judge评估模式.md)
