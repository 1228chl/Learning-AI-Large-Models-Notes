...
- 需要理解 EduAgent 系统整体定位和痛点的相关知识，参见 [四大痛点与EduAgent定位](./36-四大痛点与EduAgent定位.md)
...
- 需要了解 RAG 三阶段流程的相关知识，参见 [RAG三阶段流程](../RAG流程/02-RAG三阶段流程.md)
- 需要了解 Orchestrator 如何路由到四个 Agent 的相关知识，参见 [Orchestrator 编排器设计](./34-Orchestrator编排器设计.md)