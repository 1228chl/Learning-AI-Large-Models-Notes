...
设 $x_i$、$y_i$ 分别为向量 $x$、$y$ 的第 $i$ 个分量，$\Vert x\Vert$ 表示向量 $x$ 的模长（L2 范数）。
...
- 需要理解Milvus Python操作指南的相关知识，参见 [Milvus Python操作指南](03-Milvus Python操作指南.md)
- 需要理解嵌入与向量化的相关知识，参见 [嵌入与向量化](../检索/01-嵌入与向量化.md)
- 需要掌握点积与余弦相似度以理解向量运算与相似度计算的数学基础，参见 [点积与余弦相似度](../../数学基础/线性代数/向量/04-点积与余弦相似度.md)
