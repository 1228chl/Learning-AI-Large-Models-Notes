...
- 需要理解嵌入与向量化的相关知识，参见 [嵌入与向量化](../检索/10-嵌入与向量化.md)
- 需要理解混合检索与重排序的相关知识，参见 [混合检索与重排序](../检索/11-混合检索与重排序.md)
- 需要理解Milvus核心概念的相关知识，参见 [Milvus核心概念](08-Milvus核心概念.md)
- 需要理解Milvus Python操作的相关知识，参见 [Milvus Python操作指南](09-Milvus Python操作指南.md)
- 需要理解文档切分策略的相关知识，参见 [文档切分策略](../../AI-Agent/RAG流程/03-文档切分策略.md)
- 需要理解多格式文档加载与OCR解析的相关知识，参见 [多格式文档加载与OCR解析](../../AI-Agent/RAG流程/28-多格式文档加载与OCR解析.md)