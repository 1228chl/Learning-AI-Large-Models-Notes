...
- 需要理解父子文档分块的原理和参数配置，参见 [父文档与子文档分块策略](../../AI-Agent/RAG流程/31-父文档与子文档分块策略.md)
- 需要理解 Milvus 集合创建与 Schema 设计，参见 [Milvus集合创建与字段设计](17-Milvus集合创建与字段设计.md)
- 需要理解稠密向量与稀疏向量的区别，参见 [稠密向量与稀疏向量](../检索/16-稠密向量与稀疏向量.md)
- 需要理解 Milvus 索引类型和距离度量的选择，参见 [Milvus核心概念](08-Milvus核心概念.md)
- 需要理解 Milvus Python SDK 的基本操作，参见 [Milvus Python操作指南](09-Milvus Python操作指南.md)