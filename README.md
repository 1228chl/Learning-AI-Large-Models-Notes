...
原子卡片是基于原子化知识理念设计的知识点卡片，每张卡片围绕一个独立概念展开，包含定义（含 LaTeX 公式）、核心公式、直观理解、ML/DL 应用场景、面试追问 Q1-Q4 以及跨域引用链接。共 **260 张卡片**，覆盖 14 个分类。
...
| 工程实践 | Docker / 部署 / 工具 / 网络 | 18 | Docker 编排、Git、LLM API 部署、Vue3 前端集成、FastAPI 后台任务等 |
| 知识体系 | -- | 2 | 核心依赖链、面试追问树 |
...
| 路径 | 说明 |
|:-----|:------|
| **Atomic-Cards/** | 原子卡片库（260 张，14 分类） |
