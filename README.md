...
原子卡片是基于原子化知识理念设计的知识点卡片，每张卡片围绕一个独立概念展开，包含定义（含 LaTeX 公式）、核心公式、直观理解、ML/DL 应用场景、面试追问 Q1-Q4 以及跨域引用链接。共 **218 张卡片**，覆盖 14 个分类。
...
| 深度学习 | 基础 / PyTorch / CNN-RNN / 迁移学习 / 训练优化 / 模型压缩 / LLM | 30 | 感知机、激活函数、反向传播、CNN、RNN、LSTM、GAN、GNN、经典CNN架构、Dropout、早停等 |
...
| 路径 | 说明 |
|:-----|:------|
| **Atomic-Cards/** | 原子卡片库（218 张，14 分类） |
