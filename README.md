...
原子卡片是基于原子化知识理念设计的知识点卡片，每张卡片围绕一个独立概念展开，包含定义（含 LaTeX 公式）、核心公式、直观理解、ML/DL 应用场景、面试追问 Q1-Q4 以及跨域引用链接。共 **212 张卡片**，覆盖 14 个分类。
...
| 机器学习 | 基础 / 监督学习 / 集成学习 / 聚类 / 降维 / 特征工程 / 正则化 / LLM 评估 / 实践 | 32 | 回归、SVM、决策树、K-means、PCA、L1/L2 正则化、文本分类实战等 |
| 深度学习 | 基础 / PyTorch / CNN-RNN / 迁移学习 / 训练优化 / 模型压缩 / LLM | 26 | 感知机、激活函数、反向传播、CNN、RNN、LSTM、Transformer、GPU并行与混合精度、训练流程等 |
...
| 路径 | 说明 |
|:-----|:------|
| **Atomic-Cards/** | 原子卡片库（212 张，14 分类） |
