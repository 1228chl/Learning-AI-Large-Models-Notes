...
原子卡片是基于原子化知识理念设计的知识点卡片，每张卡片围绕一个独立概念展开，包含定义（含 LaTeX 公式）、核心公式、直观理解、ML/DL 应用场景、面试追问 Q1-Q4 以及跨域引用链接。共 **234 张卡片**，覆盖 14 个分类。
...
| AI-Agent | 基础 / RAG 流程 / 检索 / LangChain / 平台 / 协作 / 系统 | 24 | Agent 定义、RAG 实现、BM25、Coze、多 Agent、CoT 等 |
| 数据分析 | -- | 4 | NumPy、Pandas、Matplotlib |
| 工程实践 | Docker / 部署 / 工具 / 网络 | 15 | Docker 基础、Git、LLM API 部署、Claude/Conda/UV 、HTTP/WebSocket |
| 知识体系 | -- | 2 | 核心依赖链、面试追问树 |
...
| 路径 | 说明 |
|:-----|:------|
| **Atomic-Cards/** | 原子卡片库（234 张，14 分类） |
